                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <img src="{{Storage::disk('s3')->url(auth()->user()->avatar)}}" alt="{{Storage::disk('s3')->url(auth()->user()->avatar)}}" style="border: 1px solid #cccccc; border-radius: 5px; width: 39px; height: auto;float:left; margin-right: 7px;">
