@extends('layout.publiclayout', ['title' => 'Clinic Login'])
@section('content')
    <!-- Page Content -->
    <div class="content">
                    ...
                    <div class="account-content">
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-12 col-lg-6 login-right">
                                ...
                                <form method="POST" action="{{ route('clinic.login.submit') }}">
                                    @csrf
                                    ...
                                    @if (Route::has('password.request'))
                                        <div class="text-right">
                                            <a class="forgot-link" href="{{ route('clinic.password.request') }}">Forgot Password ?</a>
                                        </div>
                                    @endif
                                    ...
                                    <div class="text-center dont-have">Don’t have an account? <a href="{{route('clinic.register')}}">Register</a></div>
                                </form>
                            </div>
                        </div>
                    </div>
