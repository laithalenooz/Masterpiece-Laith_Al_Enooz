@extends('layout.publiclayout', ['title' => 'Clinic Register'])
@section('content')
    <!-- Page Content -->
    <div class="content">
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-12 col-lg-6 login-right">
                                <div class="login-header">
                                    <h3>Clinic Register <a href="{{route('register')}}">Are you a Patient?</a></h3>
                                </div>

                                <!-- Register Form -->
                                <form method="POST" action="{{ route('clinic.register.submit') }}">
                                    @csrf
                                    ...
                                    <div class="text-right">
                                        <a class="forgot-link" href="{{route('clinic.login')}}">Already have an account?</a>
                                    </div>
