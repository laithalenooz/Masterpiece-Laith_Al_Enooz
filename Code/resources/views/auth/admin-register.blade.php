@extends('layout.publiclayout', ['title' => 'Admin Register'])
@section('content')
    <!-- Page Content -->
    <div class="content">
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-12 col-lg-6 login-right">
                                <div class="login-header">
                                    <h3>Admin Register <a href="{{route('register')}}">Are you lost buddy?</a></h3>
                                </div>
                                ...
                                <form method="POST" action="{{ route('admin.register.submit') }}">
                                    ...
                                    <div class="text-right">
                                        <a class="forgot-link" href="{{route('admin.login')}}">Already have an
                                            account?</a>
                                    </div>
